Shader "WhiteCOyote/FakeLiquid"
{
	Properties
	{
		_MainTex ("Texture", 2D) = "white" {}
		_Tint ("Tint", Color) = (1, 1, 1, 1)
		_FillAmount ("FillAmount", Range(-10, 10)) = 0.0
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 RotateAroundYInDegrees(float4 vertex, float degress)
			{
				float alpha = degress * UNITY_PI / 180;
				float sina, cosa;
